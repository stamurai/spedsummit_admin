      ...
      <div className="aa-header">
        ...
        <div style={{ display:"flex", alignItems:"center", gap:8 }}>
          ...
          <button onClick={() => onOpenComments?.()}
            ...
            <span style={{ fontSize:14, fontWeight:600, color:C.gray900 }}>Comments</span>
          </button>
        <div style={{ position:"relative" }}>
...
function SessionAnalyticsPage({ session, onBack }) {
  ...
  return (
    <div style={{ background:C.gray50, minHeight:"100%", padding:24, fontFamily:"'Inter',-apple-system,sans-serif" }}>
      <div style={{ display:"flex", alignItems:"center", gap:6, margin:"-24px -24px 24px", padding:"12px 24px", background:C.white, borderBottom:`1px solid ${C.gray200}` }}>
